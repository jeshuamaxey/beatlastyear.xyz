-- taken from: https://github.com/supabase-community/supabase-custom-claims
-- exact commit: https://github.com/supabase-community/supabase-custom-claims/blob/2b14ae88c94c8bf12587897022ae861cd2b1a00c/install.sql
